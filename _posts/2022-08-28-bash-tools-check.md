---
keywords: fastai
description: This is my tools check page to ensure that I have all of the necessary tools installed on my machine. These tools include Python, Conda, and Jupyter.
title: Key Tools Check
toc: true
comments: true
permalink: /tools_check/bash
image: /images/computertools.jpg
categories: [week 1]
nb_path: _notebooks/2022-08-28-bash-tools-check.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-08-28-bash-tools-check.ipynb
-->
...
<h1 id="Checking-for-Conda-Packages">Checking for Conda Packages<a class="anchor-link" href="#Checking-for-Conda-Packages"> </a></h1>
</div>
</div>
</div>
    {% raw %}
...
<pre># packages in environment at /home/avac54765/anaconda3:
#
...
<span class="c1"># this tells the user that they are checking for kernal installation</span>

<span class="nv">test</span><span class="o">=</span><span class="s2">&quot;jupyter&quot;</span> 
...
<span class="c1">#if, then, else, fi= tests for installation uses a fallback if the test fails</span>
</pre></div>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Checking-for-Python">Checking for Python<a class="anchor-link" href="#Checking-for-Python"> </a></h1>
</div>
</div>
</div>
    {% raw %}
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Checking-for-Jupyter-Installations">Checking for Jupyter Installations<a class="anchor-link" href="#Checking-for-Jupyter-Installations"> </a></h1>
</div>
</div>
</div>
    {% raw %}
...
traitlets        : 5.3.0
Available kernels:
  bash          /home/avac54765/.local/share/jupyter/kernels/bash
  javascript    /home/avac54765/.local/share/jupyter/kernels/javascript
  python3       /home/avac54765/.local/share/jupyter/kernels/python3
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-bash"><pre><span></span><span class="nv">test</span><span class="o">=</span><span class="s2">&quot;python3&quot;</span> 
<span class="nv">check</span><span class="o">=</span><span class="sb">`</span>jupyter kernelspec list <span class="p">|</span> grep <span class="nv">$test</span><span class="sb">`</span> 
<span class="nv">n</span><span class="o">=</span><span class="si">${#</span><span class="nv">check</span><span class="si">}</span> 
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>  python3       /home/avac54765/.local/share/jupyter/kernels/python3
</pre>
</div>
</div>
